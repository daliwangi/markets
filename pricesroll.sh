...
uxterm -T 'BTC Bitfinex' -geometry 7x8+108+455 -e "/home/jsn/_scripts/markets/bitfinex.sh" &
...
uxterm -T 'BTC Book Depth Binance' -geometry 36x44+800+0 -e '/home/jsn/_scripts/markets/binance.sh -dd' &
